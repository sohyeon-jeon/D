            ...
            <fieldset>
               ...
               <div class="form-group">
                  <label for="email"><b>이메일</b></label>
                   <input type="email" class="form-control" id="email" value="sl@dsq.com" readonly>
               </div>
               ...
               <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="name" placeholder="김땡땡">
               </div>
               
               
               <div class="form-group">
                  <label for="nickname"><b>닉네임</b></label> 
                  <input type="text" class="form-control" id="nickname" placeholder="빵빵빵">
               </div>
               ...
               <div class="form-group">
                  ...
                  <div class="form-group">
                     <div class="input-group mb-3">
                        <input type="text" class="form-control" id="tel" placeholder="새 전화번호">
                        <div class="input-group-append">
                           <button type="button" class="btn btn-secondary"
