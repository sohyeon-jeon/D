...
<title>dsq_board_list.jsp</title>
<!-- 부트스트랩 -->
    ...
    <text x="50%" y="50%" fill="#dee2e6" dy=".3em">Image cap</text>
			...
			<div class="col-sm-6">
				<ul class="nav nav-tabs">
					...
					<li class="nav-item"><a
						class="nav-link btn btn-primary btn-sm" data-toggle="tab"
						href="#emergency" id="emergency2"> <span
							class="glyphicon glyphicon-bell" aria-hidden="true"></span> 긴급질문
					</a></li>
				</ul>
				<br>
						...
						<div class="card bg-light">
							<div class="card-body">
								<div class="d-flex w-100 justify-content-between">
									<h4 class="card-title">
										<a href="#"> <i class="fa fa-quora" aria-hidden="true"></i>
											긴급질문입니다. <span class="badge badge-secondary">현상금</span>
										</a>
									</h4>
									<small> <span class="glyphicon glyphicon-thumbs-up"
										aria-hidden="true"></span> 추천수
			...
			<div class="col-sm-3">
				...
				<div style="max-width: 20rem;">
					<a href="#"><button type="button"
							class="btn btn-primary btn-block">질문하기</button></a>
				</div>
			</div>
		</div>
	</div>
